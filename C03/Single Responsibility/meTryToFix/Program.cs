...
public class Program
{
    ...
    private static void FetchAndDisplayBook()
    {
        ...
        // In the preceding line, the null forgiving operator ('!') // tells the analyzer that the 'book' variable is not null // because we know it isn't. In a more dynamic scenario, we // should validate if the book variable is not null.
    }
