...
public abstract class BaseLSPTest
{
    ...
    //The Add() method should not add a ninja more than once:
    [Fact]
    ...
    //The Members property of the HallOfFame class should return the ninja ordered by their number of
    //kills, from the most to the least:
    [Fact]
