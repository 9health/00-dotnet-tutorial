...
public class MealVerD : IEnumerable {

    // Members
    public List<NHFoodVerD> foods = new List<NHFoodVerD>();

    // Public methods
    public void AddFood(int foodID, string foodName, int foodTime) {
        foods.Add(new NHFoodVerD { FoodId = foodID, FoodName = foodName, FoodTime = foodTime } );
    }
 ...
 // public IEnumerable<NHFoodVerD> TopN(int n) {
