...
namespace Given
{
    ...
    public class Photo : Form
    {
        ...
        public Photo()
        {
            string filePath = Combine(CurrentDirectory, "jug.bmp");
...
class DecoratorPatternExample
{
    ...
    class BorderedPhoto : Photo // the decorators can inherit directly from the component and maintain an object of that class as well.
    {
        Photo photo;
        Color color;
    ...
    static void Main()
    {
        ...
        Console.WriteLine(colorTaggedPhoto.ListTaggedPhoto());
        ...
        Application.Run(composition);
        Console.WriteLine(tag.ListTaggedPhoto());
    }
}
